<template>
  <div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div class="form-group">
        ...
        <div class="relative">
          ...
          <input
            ...
            :aria-describedby="
              loanAmountError ? 'loan-amount-error' : 'loan-amount-help'
            "
            placeholder="300,000"
            required
          />
      ...
      <div class="form-group">
        ...
        <div class="relative">
          <input
            ...
            :aria-describedby="
              interestRateError ? 'interest-rate-error' : 'interest-rate-help'
            "
            placeholder="3.5"
            required
          />
    ...
    <div
      v-if="mortgage.presentation.value.isValid && !isCalculating"
    ...
    >
      ...
      <div class="mt-4 pt-4 border-t border-blue-200">
        <p class="text-sm text-blue-700">
          ...
          {{ formatCurrency(mortgage.presentation.value.monthlyPrincipal) }}
          principal +
          {{ formatCurrency(mortgage.presentation.value.monthlyInterest) }}
          interest
        </p>
      </div>
    </div>
    ...
    <!-- Error Display -->
    <div
      v-if="mortgage.presentation.value.errorMessage"
