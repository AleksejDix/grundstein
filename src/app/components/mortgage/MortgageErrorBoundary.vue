<template>
  <div
    v-if="hasError"
    class="max-w-2xl mx-auto p-6 bg-red-50 border border-red-200 rounded-lg"
  >
    <div class="flex items-start">
      ...
      <div class="ml-3 flex-1">
        ...
        <p class="text-red-700 mb-4">
          {{
            errorMessage ||
            "The mortgage calculator encountered an unexpected error. Please try refreshing the page."
          }}
        </p>
        ...
        <details v-if="isDevelopment" class="mt-4">
          ...
          <pre
            class="mt-2 text-xs text-red-600 bg-red-100 p-3 rounded border overflow-auto"
