...
import { createPercentage, toPercentageValue } from "./Percentage";
import type { Money } from "./Money";
import { createMoney, toEuros } from "./Money";
...
import { getAmountAsEuros } from "./ExtraPayment";
import type { FixedRatePeriod } from "./FixedRatePeriod";
import { isCurrentlyActive, getRemainingYears } from "./FixedRatePeriod";
...
> = {
  Sparkasse: {
    ...
    feeStructure: {
      feeType: "Percentage",
      percentageFee: createPercentage(1.0).data!, // 1% fee typical for Sparkasse
    },
  },
  ...
  Privatbank: {
    ...
    feeStructure: {
      feeType: "Fixed",
      baseFee: createMoney(250).data!, // €250 typical private bank fee
    },
  },
  ...
  Bausparkasse: {
    ...
    feeStructure: {
      feeType: "Tiered",
      percentageFee: createPercentage(0.5).data!,
      excessFeePercentage: createPercentage(2.0).data!,
    },
  },
  ...
  Volksbank: {
    ...
    feeStructure: {
      feeType: "Percentage",
      percentageFee: createPercentage(1.0).data!,
    },
  },
  ...
  Genossenschaftsbank: {
    ...
    feeStructure: {
      feeType: "Percentage",
      percentageFee: createPercentage(0.75).data!,
    },
  },
};
