...
import type { PaymentMonth } from "../types/PaymentMonth";
import {
  createPaymentMonth,
  toNumber as paymentMonthToNumber,
} from "../types/PaymentMonth";
...
import type { MonthCount } from "../types/MonthCount";
import {
  createMonthCount,
  toNumber as monthCountToNumber,
} from "../types/MonthCount";
import type { Percentage } from "../types/Percentage";
import {
  createPercentage,
  toDecimal as percentageToDecimal,
} from "../types/Percentage";
import type { LoanAmount } from "../types/LoanAmount";
import { toNumber as loanAmountToNumber } from "../types/LoanAmount";
import type { InterestRate } from "../types/InterestRate";
import { toDecimal } from "../types/InterestRate";
import {
